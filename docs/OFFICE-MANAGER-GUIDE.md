...
7. **Publish the Employee Viewer.** Create the employee access code, confirm the month is ready, publish the encrypted link and share the code separately.
...
Source workbooks are read locally and are never rewritten by NEXUS. Never place timesheets, Employee Register data, generated reports, access codes or confidential workbooks in GitHub.
